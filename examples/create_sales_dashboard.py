...
class SalesDashboardBuilder:
    ...
    filter_widgets = [
      ...
      },
      {
        ...
        'params': {
          ...
          'date_field': 'date',
          'title': 'Date Range',
          'default_range': {'start': '2024-01-01', 'end': '2024-12-31'},
        },
      },
      {
        'type': 'dropdown_filter',
  ...
  def apply_layout(self) -> Dict[str, Any]:
    ...
    layout_result = auto_layout_dashboard(dashboard_id=self.dashboard_id, layout_type='grid')
...
def main():
  ...
  try:
    ...
    builder.create_kpi_widgets()
    builder.create_chart_widgets()
    builder.create_table_widgets()
