    ...
    def list_queries(warehouse_id: str = None) -> dict:
        ...
        try:
            ...
            return {
                ...
                'warehouse_id': warehouse_id,
                'message': f'Found {len(query_list)} query(ies)' + (f' for warehouse {warehouse_id}' if warehouse_id else ''),
            }
        ...
        try:
            ...
            return {
                ...
                'query': {
                    ...
                    'manifest': {
                        'schema': [{'name': col.name, 'type': col.type} for col in query.manifest.schema.columns]
                    } if query.manifest and query.manifest.schema else None,
                },
